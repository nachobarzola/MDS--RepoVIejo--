...
import mds.trabajopractico.sistemabecasalimentarias.services.interfaces.presentacion.MenuJPanelService;

@Component
public class MenuJPanel extends JPanel implements MenuJPanelService{
